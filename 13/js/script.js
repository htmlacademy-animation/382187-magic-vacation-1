...
/* harmony import */ var _prizes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prizes.js */ "./source/js/modules/prizes.js");
  ...
  changeActiveMenuItem() {
    ...
    if (activeItem) {
      ...
      if (activeItem.dataset.href === `prizes`) {
        Object(_prizes_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
      }
    }
  }
...
/*!**************************************!*\
  !*** ./source/js/modules/helpers.js ***!
  \**************************************/
/*! exports provided: bounce, makeEaseOut, animateEasing, animateProgress, animateDuration, runSerial, skewCtx, rotateCoords, rotateCtx, tick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bounce", function() { return bounce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeEaseOut", function() { return makeEaseOut; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "skewCtx", function() { return skewCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rotateCoords", function() { return rotateCoords; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rotateCtx", function() { return rotateCtx; });
...
const skewCtx = (ctx, x, y) => {
  ctx.transform(1, x, y, 1, 0, 0);
};

const rotateCoords = (cx, cy, x, y, angle) => {
...
/***/ "./source/js/modules/letter-animation.js":
/*!***********************************************!*\
  !*** ./source/js/modules/letter-animation.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _typography_build_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./typography-build.js */ "./source/js/modules/typography-build.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const animationTopScreenTitleLine = new _typography_build_js__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 700, `active`, `transform`, ANIMATION_STEP, `intro__word`);
  setTimeout(() => {
    animationTopScreenTitleLine.runAnimation();
  }, 500);

  const animationTopScreenTextLine = new _typography_build_js__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 500, `active`, `transform`, ANIMATION_STEP, `intro__date-word`, animatingOffset);
  setTimeout(() => {
...
/***/ "./source/js/modules/page-loaded.js":
/*!******************************************!*\
  !*** ./source/js/modules/page-loaded.js ***!
  \******************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/seacalf-scene/index.js":
/*!**************************************************!*\
  !*** ./source/js/modules/seacalf-scene/index.js ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _plane__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./plane */ "./source/js/modules/seacalf-scene/plane.js");
/* harmony import */ var _seacalf__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./seacalf */ "./source/js/modules/seacalf-scene/seacalf.js");
/* harmony import */ var _snowflake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./snowflake */ "./source/js/modules/seacalf-scene/snowflake.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers */ "./source/js/modules/helpers.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const opacityAnimationTick = (from, to) => (progress) => {
    opacity = Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["tick"])(from, to, progress);
  };
  ...
  const startSnowflakesAnimationInfinite = () => {
    const globalAnimationTick = (globalProgress) => {
      if (globalProgress === 0) {
        ...
        Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["animateProgress"])(opacityAnimationTick(opacity, 1), SNOWFLAKES_OPACITY_DURATION);

        Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["runSerial"])([
    ...
    const animations = [
      () => Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["animateDuration"])(globalAnimationTick, ANIMATION_DURATION)
    ];

    Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["runSerial"])(animations).then(startSnowflakesAnimationInfinite);
  };
...
/***/ "./source/js/modules/seacalf-scene/plane.js":
/*!**************************************************!*\
  !*** ./source/js/modules/seacalf-scene/plane.js ***!
  \**************************************************/
/*! exports provided: default */
...
class Plane {
  ...
  getPlaneTrace() {
    ...
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCoords"])(center.x, center.y, zeroDegreeCoords.x, zeroDegreeCoords.y, this.planePosition.angle);
  }

  opacityAnimationTick(from, to) {
    return (progress) => {
      this.opacity = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  planePositionAnimationTick(from, to) {
    return (progress) => {
      this.planePosition.left = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
  ...
  planeRotateAnimationTick(from, to) {
    return (progress) => {
      this.planePosition.angle = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, Math.pow(progress, 2.5));
    };
  }
  ...
  backgroundAnimationTick(from, to) {
    return (progress) => {
      ...
      this.background.size = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  leftTreePositionTick(from, to) {
    return (progress) => {
      this.leftTree.offset = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  animate() {
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(0, 1), this.duration);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.planePositionAnimationTick(this.initialPlanePosition, this.finalPlanePosition), this.duration);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.planeRotateAnimationTick(this.initialPlanePosition.angle, this.finalPlanePosition.angle), this.duration);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.backgroundAnimationTick(this.initialBackground.size, this.finalBackground.size), this.duration);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.leftTreePositionTick(this.leftTreeInitialOffset, this.leftTreeFinalOffset), this.duration);
  }

  drawPlane() {
    this.ctx.save();
    const {x, y} = this.getPlaneCenter();
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCtx"])(this.ctx, this.planePosition.angle, x, y);
...
/***/ "./source/js/modules/seacalf-scene/seacalf.js":
/*!****************************************************!*\
  !*** ./source/js/modules/seacalf-scene/seacalf.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Seacalf; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./source/js/modules/helpers.js");
...
class Seacalf {
  ...
  translateYAnimationTick(from, to) {
    return (progress) => {
      this.translateY = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  rotateAnimationTick(from, to) {
    return (progress) => {
      this.angle = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from, to, progress);
    };
  }

  animate() {
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["runSerial"])([
      () => Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.translateYAnimationTick(this.initialPosition.top, this.finalPosition.top), this.duration * 0.6),
      () => Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateEasing"])(this.rotateAnimationTick(30, 0), this.duration * 0.5, Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["makeEaseOut"])(_helpers__WEBPACK_IMPORTED_MODULE_0__["bounce"]))
    ]);
  }
  ...
  draw() {
    ...
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["rotateCtx"])(this.ctx, this.angle, x, y);
...
/***/ "./source/js/modules/seacalf-scene/snowflake.js":
/*!******************************************************!*\
  !*** ./source/js/modules/seacalf-scene/snowflake.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Snowflake; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./source/js/modules/helpers.js");
...
class Snowflake {
  ...
  animate() {
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.translateYAnimationTick.bind(this), this.duration);
  }

  draw() {
    this.ctx.save();
    this.ctx.translate(this.initialPosition.left, this.initialPosition.top - this.currentOffset);
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["skewCtx"])(this.ctx, ...this.skew);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _seacalf_scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./seacalf-scene */ "./source/js/modules/seacalf-scene/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  function showTime() {
    ...
    if (remainingTime >= 1000) {
      ...
      Object(_seacalf_scene__WEBPACK_IMPORTED_MODULE_0__["default"])();
    }
  }
...
/***/ "./source/js/modules/typography-build.js":
/*!***********************************************!*\
  !*** ./source/js/modules/typography-build.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TypographyBuild; });
class TypographyBuild {
  constructor(
      elementSelector,
      timer,
      classForActivate,
...
/* harmony import */ var _modules_letter_animation_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/letter-animation.js */ "./source/js/modules/letter-animation.js");
// modules
...
Object(_modules_letter_animation_js__WEBPACK_IMPORTED_MODULE_11__["default"])();
