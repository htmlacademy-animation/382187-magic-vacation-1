...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const animationTopScreenTitleLine = new _typography_build_js__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__title`, 700, `active`, `transform`, `intro__word`);
  setTimeout(() => {
    animationTopScreenTitleLine.runAnimation();
  }, 500);

  const animationTopScreenTextLine = new _typography_build_js__WEBPACK_IMPORTED_MODULE_0__["default"](`.intro__date`, 500, `active`, `transform`, `intro__date-word`, animatingOffset);
  setTimeout(() => {
