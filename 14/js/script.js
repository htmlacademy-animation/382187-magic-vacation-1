...
/***/ "./source/js/modules/crocodile-scene/crocodile.js":
/*!********************************************************!*\
  !*** ./source/js/modules/crocodile-scene/crocodile.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Crocodile; });
...
class Crocodile {
  ...
  positionAnimationTick(from, to) {
    return (progress) => {
      this.position.left = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
      this.position.top = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.top, to.top, progress);
    };
  }
  ...
  animate() {
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.positionAnimationTick(this.initialPosition, this.finalPosition), this.duration);
  }
}
...
/***/ "./source/js/modules/crocodile-scene/index.js":
/*!****************************************************!*\
  !*** ./source/js/modules/crocodile-scene/index.js ***!
  \****************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./source/js/modules/helpers.js");
/* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./key */ "./source/js/modules/crocodile-scene/key.js");
/* harmony import */ var _thing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./thing */ "./source/js/modules/crocodile-scene/thing.js");
/* harmony import */ var _crocodile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./crocodile */ "./source/js/modules/crocodile-scene/crocodile.js");
/* harmony import */ var _tear__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tear */ "./source/js/modules/crocodile-scene/tear.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const key = new _key__WEBPACK_IMPORTED_MODULE_1__["default"]({duration: ANIMATION_DURATION, ctx, src: `./img/key.png`});
  const {flamingoOptions, watermelonOptions, snowflakeOptions, saturnOptions, leafOptions} = things;
  const flamingo = new _thing__WEBPACK_IMPORTED_MODULE_2__["default"]({duration: ANIMATION_DURATION, ctx, src: flamingoOptions.src, sizes: flamingoOptions.sizes, positions: flamingoOptions.positions});
  const watermelon = new _thing__WEBPACK_IMPORTED_MODULE_2__["default"]({duration: ANIMATION_DURATION, ctx, src: watermelonOptions.src, sizes: watermelonOptions.sizes, positions: watermelonOptions.positions});
  ...
  const startTearAnimationLoop = () => {
    ...
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["runSerial"])(animations).then(startTearAnimationLoop);
  };
...
/***/ "./source/js/modules/crocodile-scene/key.js":
/*!**************************************************!*\
  !*** ./source/js/modules/crocodile-scene/key.js ***!
  \**************************************************/
/*! exports provided: default */
...
class Key {
  ...
  sizeAnimationTick(from, to) {
    return (progress) => {
      this.size.width = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.width, to.width, progress);
      this.size.height = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.height, to.height, progress);
    };
  }
  ...
  animate() {
    ...
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.sizeAnimationTick(this.size, this.finalSize), this.duration);
  }
}
...
/***/ "./source/js/modules/crocodile-scene/tear.js":
/*!***************************************************!*\
  !*** ./source/js/modules/crocodile-scene/tear.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Tear; });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./source/js/modules/helpers.js");
...
class Tear {
  ...
  animate() {
    Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["runSerial"])([
      () => {
        Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(0, 1), this.duration * 0.1);
        Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.sizeAnimationTick(this.initialSize, this.finalSize), this.duration * 0.1);
      },
      () => Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.positionYAnimationTick(this.initialPosition, this.finalPosition), this.duration),
      () => Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])(this.opacityAnimationTick(1, 0), this.duration * 0.1)
    ]);
  }
}
...
/***/ "./source/js/modules/crocodile-scene/thing.js":
/*!****************************************************!*\
  !*** ./source/js/modules/crocodile-scene/thing.js ***!
  \****************************************************/
/*! exports provided: default */
...
class Thing {
  ...
  positionAnimationTick(from, to) {
    return (progress) => {
      this.positions.left = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.left, to.left, progress);
      this.positions.top = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.top, to.top, progress);
    };
  }

  sizeAnimationTick(from, to) {
    return (progress) => {
      this.initialSize.width = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.width, to.width, progress);
      this.initialSize.height = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["tick"])(from.height, to.height, progress);
    };
  }
...
/*!**************************************!*\
  !*** ./source/js/modules/helpers.js ***!
  \**************************************/
/*! exports provided: bounce, makeEaseOut, animateEasing, animateProgress, animateDuration, runSerial, skewCtx, rotateCoords, rotateCtx, tick, bezierEasing */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _crocodile_scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./crocodile-scene */ "./source/js/modules/crocodile-scene/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  function showTime() {
    ...
    if (remainingTime >= 1000) {
      ...
      Object(_crocodile_scene__WEBPACK_IMPORTED_MODULE_0__["default"])();
    }
  }
